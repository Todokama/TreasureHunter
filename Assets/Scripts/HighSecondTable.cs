...
public class HighSecondTable : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        string jsonString = PlayerPrefs.GetString("highscoreSecoTable");
        ...
        if (highscores == null)
        {
            ...
            AddHighscoreEntry(0, "Player");
            // Reload
            jsonString = PlayerPrefs.GetString("highscoreSecoTable");
    ...
    public static void AddHighscoreEntry(int score, string name)
    {
        ...
        PlayerPrefs.SetString("highscoreSecoTable", json);
        PlayerPrefs.Save();
    }
