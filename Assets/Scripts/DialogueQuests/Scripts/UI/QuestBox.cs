...
namespace DialogueQuests
{
    ...
    public class QuestBox : UIPanel {
        ...
        protected override void Start()
        {
            ...
            NarrativeManager.Get().onQuestStart += (QuestData quest) => { ShowBox(quest, "Новое Задание"); };
            NarrativeManager.Get().onQuestComplete += (QuestData quest) => { ShowBox(quest, "Задание Выполнено"); };
            NarrativeManager.Get().onQuestFail += (QuestData quest) => { ShowBox(quest, "Задание Провалено"); };
        }
